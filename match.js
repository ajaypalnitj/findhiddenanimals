...
class MatchGame {
    constructor() {
        this.score = 0;
        this.highScore = parseInt(localStorage.getItem('matchGameHighScore')) || 0;
        this.timeLeft = 30;
        this.timer = null;
        this.cards = [];
        this.selectedCards = [];
    ...
    createCards() {
        ...
        const gameAnimals = Object.values(ANIMALS).slice(0, 5);
    ...
    endGame(won) {
        ...
        if (this.score > this.highScore) {
            ...
            localStorage.setItem('matchGameHighScore', this.highScore);
        }
